"""
Download pretrained models from HuggingFace and save to local directory.
...
def download_mbert(save_dir):
    """Download mBERT (bert-base-multilingual-cased)."""
...
def download_xlmr(save_dir):
    """Download XLM-R (xlm-roberta-base)."""
...
def download_mt5(save_dir):
    """Download mT5-small (google/mt5-small)."""
